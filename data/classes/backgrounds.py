...
class AGBackground:
        ...
        def update(self, dt):
            ...
            if self.mult_color[0] == 255 and self.mult_color[1] == 0 and self.mult_color[2] < 255:
                self.mult_color[2] += 1
            elif self.mult_color[0] != 0 and self.mult_color[1] == 0 and self.mult_color[2] == 255:
                self.mult_color[0] -= 1
            elif self.mult_color[0] == 0 and self.mult_color[1] < 255 and self.mult_color[2] == 255:
                self.mult_color[1] += 1
            elif self.mult_color[0] == 0 and self.mult_color[1] == 255 and self.mult_color[2] != 0:
                self.mult_color[2] -= 1
            elif self.mult_color[0] < 255 and self.mult_color[1] == 255 and self.mult_color[2] == 0:
                self.mult_color[0] += 1
            elif self.mult_color[0] == 255 and self.mult_color[1] != 0 and self.mult_color[2] == 0:
                self.mult_color[1] -= 1
